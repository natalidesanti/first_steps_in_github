...
\begin{table}[h!]
 \begin{center}
  \begin{tabular}{c|c|c}
   ...
   & Create a & \\
   & new banch & \\
   & and switsh & \texttt{git checkout -b name\_of\_branch}\\
   & to it & \\
   & or commit & \\
   \cline{2-3}
   & Switch from & \\
...
To write the \textbf{First steps on GitHub} I really appreciate the Nícolas Morazotti (\href{https://github.com/Morazotti}{\texttt{@Morazotti}}) help, the \href{https://guides.github.com/activities/hello-world/}{\texttt{Hello World}} project and the Wikipedia pages for \href{https://en.wikipedia.org/wiki/GitHub}{GitHub} and \href{https://en.wikipedia.org/wiki/Git}{git}.
